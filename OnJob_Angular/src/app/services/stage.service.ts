...
export class StageService {
  ...
  public add(datas: Stage):Observable<StageDetail>{
    return this.http.post<StageDetail>(this.api.apiUrl.candidatetypes, datas);
  }

  public update(datas: Stage):Observable<StageDetail>{
    return this.http.put<StageDetail>(this.api.apiUrl.candidatetypes + '/' + datas.id, datas);
  }

  public delete(id):Observable<StageDetail>{
    return this.http.delete<StageDetail>(this.api.apiUrl.candidatetypes + '/' + id);
  }

  public getStageId(id): Observable<StageDetail>{
    return this.http.get<StageDetail>(this.api.apiUrl.candidatetypes + '/' + id)
  }
}
